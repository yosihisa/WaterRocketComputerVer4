...
$(BINARYDIR)/startup_stm32f401xc.o : $(BSP_ROOT)/STM32F4xxxx/StartupFiles/startup_stm32f401xc.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
...
$(BINARYDIR)/stm32f4xx_hal_dfsdm.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dfsdm.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
...
$(BINARYDIR)/stm32f4xx_hal_mmc.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_mmc.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
...
$(BINARYDIR)/stm32f4xx_ll_adc.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_adc.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/stm32f4xx_ll_crc.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_crc.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/stm32f4xx_ll_dac.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dac.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/stm32f4xx_ll_dma.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/stm32f4xx_ll_dma2d.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma2d.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/stm32f4xx_ll_exti.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
...
$(BINARYDIR)/stm32f4xx_ll_gpio.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_gpio.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/stm32f4xx_ll_i2c.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_i2c.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/stm32f4xx_ll_lptim.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_lptim.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/stm32f4xx_ll_pwr.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_pwr.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/stm32f4xx_ll_rcc.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/stm32f4xx_ll_rng.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rng.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/stm32f4xx_ll_rtc.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rtc.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
...
$(BINARYDIR)/stm32f4xx_ll_spi.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_spi.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/stm32f4xx_ll_tim.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_tim.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/stm32f4xx_ll_usart.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
...
$(BINARYDIR)/stm32f4xx_ll_utils.o : $(BSP_ROOT)/STM32F4xxxx/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
